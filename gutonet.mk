...
default_makery: ${MAKEFILE_SCRIPT_PATH}/python.mk ${MAKEFILE_SCRIPT_PATH}/github.mk ${MAKEFILE_SCRIPT_PATH}/deploy.mk
...
ifeq "true" "${shell test -f ${MAKEFILE_SCRIPT_PATH}/deploy.mk && echo true}"
include ${MAKEFILE_SCRIPT_PATH}/deploy.mk
endif
...
${MAKEFILE_SCRIPT_PATH}/deploy.mk:
	@echo "Download deploy.mk at extras/makefiles: \c"
	@mkdir -p ${MAKEFILE_SCRIPT_PATH} && \
		cd ${MAKEFILE_SCRIPT_PATH} && \
		${GH_WGET} ${MAKERY_BASE_URL}/deploy.mk && \
		touch deploy.mk
	${CHECK}
